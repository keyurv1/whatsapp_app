...
import com.example.whatschatsapp.databinding.DeleteDialogBinding;
import com.example.whatschatsapp.databinding.ItemReceiveGroupBinding;
import com.example.whatschatsapp.databinding.ItemSentGroupBinding;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ReactionPopup popup = new ReactionPopup(context, config, (pos) -> {
            if(holder.getClass() == SentViewHolder.class) {
                ...
                viewHolder.binding.filling.setImageResource(reactions[pos]);
                viewHolder.binding.filling.setVisibility(View.VISIBLE);
            } else {
        ...
        if(holder.getClass() == SentViewHolder.class) {
            ...
            if(message.getFilling() >= 0) {
                viewHolder.binding.filling.setImageResource(reactions[message.getFilling()]);
                viewHolder.binding.filling.setVisibility(View.VISIBLE);
            } else {
                viewHolder.binding.filling.setVisibility(View.GONE);
            }
